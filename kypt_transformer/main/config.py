...
import sys
from kypt_transformer.common.utils.dir import add_pypath, make_folder
...
class Config:
    ...
    joint_regr_np_path=os.path.join(os.path.curdir, os.path.join('kypt_transformer','tool', 'MANO_joint_regressor', 'J_regressor_mano_ih26m.npy'))
    assert os.path.exists(joint_regr_np_path), 'Unable to find J_regressor_mano_ih26m.npy'

    skeleton_file=os.path.join(os.path.curdir, os.path.join('kypt_transformer','tool', 'hand_skeleton', 'skeleton.txt'))
    assert os.path.exists(skeleton_file), 'Unable to find skeleton.txt'

    obj_kps_dir=os.path.join(os.path.curdir, os.path.join('kypt_transformer','tool', 'ho3d_object_kps'))
