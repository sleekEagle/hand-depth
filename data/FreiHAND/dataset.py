...
class FreiHAND(torch.utils.data.Dataset):
    def __init__(self, conf):
        dataset_name = 'FreiHAND_pub_v2'
        self.data_split = conf.mode
        self.data_path = osp.join(conf.data_dir, dataset_name)
        ...
        det_path = osp.join(self.data_path, f'hrnet_output_on_{conf.mode}set.json')
