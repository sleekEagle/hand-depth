'''
derived from https://github.com/shreyashampali/ho3d/blob/master/utils/vis_utils.py
this is very similar to the file utils/vis_utils.py in the above repo
'''
...
def read_RGB_img(base_dir, seq_name, file_id):
...
def read_annotation(base_dir, seq_name, file_id):
    meta_filename = os.path.join(base_dir, seq_name, 'meta', file_id + '.pkl')
